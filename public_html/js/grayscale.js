...
function init() {
    ...
    var neuroTechLA = new google.maps.Marker({
        position: new google.maps.LatLng(34.05, -118.250),
        map: map,
        icon: image,
        title: 'NeuroTechLA',
        animation: google.maps.Animation.DROP
    ...
    var neuroTechAMS = new google.maps.Marker({
        position: new google.maps.LatLng(52.36, 4.90),
        map: map,
        icon: image,
        title: 'NeuroTechAMS',
        animation: google.maps.Animation.DROP
    ...
    // neuroTechNYC
    var content_nyc = '<div style="color: black;font-family: \"Helvetica Neue\";">'
    ...
    // neuroTechBOS
    var content_bos = '<div style="color: black;font-family: \"Helvetica Neue\";">'
                  + '<b>NeuroTechBOS</b><br>Boston chapter of NeuroTechX<br>'
                  + '<b><a href="http://meetup.com/NeuroTechBOS" target="_blank">BOS.neurotechx.com</a></b></div>';
  ...
  // neuroTechLA
    var contentla = '<div style="color: black;font-family: \"Helvetica Neue\";">'
                  + '<b>NeuroTechLA</b><br>LA chapter of NeuroTechX<br>'
                  + '<b><a href="http://meetup.com/NeuroTechLA" target="_blank">LA.neurotechx.com</a></b></div>';
    var infowindowLA = new google.maps.InfoWindow({
      content: contentla
    });
    google.maps.event.addListener(neuroTechLA, 'click', function() {
      infowindowLA.open(map,neuroTechLA);
    });

    // neuroTechAMS
    var conten_ams = '<div style="color: black;font-family: \"Helvetica Neue\";">'
    ...
    // neuroTechPAR
    var content_par = '<div style="color: black;font-family: \"Helvetica Neue\";">'
    ...
    google.maps.event.addListener(neuroTechPAR, 'click', function() {
      infowindowPAR.open(map,neuroTecPAR);
    });


    // neuroTechMTL
    var conten_mtl = '<div style="color: black;font-family: \"Helvetica Neue\";">'
    ...
    // neuroTechTO
    var conten_to = '<div style="color: black;font-family: \"Helvetica Neue\";">'
  ...
  // neuroTechSF
    var conten_sf = '<div style="color: black;font-family: \"Helvetica Neue\";">'
    ...
    // neuroTechTLV
    var conten_tlv = '<div style="color: black;font-family: \"Helvetica Neue\";">'
