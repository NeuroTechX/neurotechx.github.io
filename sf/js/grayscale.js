...
function init() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(37.76922, -122.4520),  // Centered on NYC-ish / East coast because this is where you have most chapters for now
    ...
    var neuroTechSF = new google.maps.Marker({
        position: new google.maps.LatLng(37.76243, -122.4317),
        map: map,
        icon: image,
        title: 'NeuroTechSF',
